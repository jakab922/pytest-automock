# -*- coding: utf-8 -*-
#
# pytest-automock documentation build configuration file, created by
...
project = u'pytest-automock'
copyright = u'2015, Daniel Papp'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-automock Documentation',
     [author], 1)
]
